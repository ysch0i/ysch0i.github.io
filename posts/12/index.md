...
전체 System은 orthonomal basis $\varphi_n$ 의 superposition으로 표현할 수 있다.

$$
\begin{align}\ket{\psi} &= \sum_n \ket{\varphi_n} \braket{\varphi_n \,| \,\psi} \\&= \sum_n c_n \ket{\varphi_n}\end{align}
$$
...
$$
\begin{align}
\braket{\psi | A | \psi} &= \sum_{n,n'} c_n^* c_{n'} \braket{\varphi_n | A | \varphi_{n'}} 
\end{align}
$$
...
$$
\begin{align}
\braket{\varphi_{n'} | \hat{\rho} | \varphi_n} \stackrel{\text{def}}{=} \rho_{n'n}
\end{align}
$$
...
$$
\begin{align}
\braket{\psi | A | \psi} &= \sum_{n,n'}\braket{\varphi_n | A | \varphi_{n'}} \rho_{n'n} \\&= \sum_{n,n'}\braket{\varphi_n | A | \varphi_{n'}} \braket{\varphi_{n'} | \hat{\rho} | \varphi_n} \\&= \sum_{n}\braket{\varphi_n | A \sum_{n'}|  \varphi_{n'}} \braket{\varphi_{n'} | \hat{\rho} | \varphi_n} \\&= \sum_n \braket{\varphi_n |A\hat{\rho} | \varphi_n} \\&= \text{Tr}\, \rho A
...
고전적인 통계역학에서도 그렇듯이 일반적으로 ensemble을 만들 때는 system의 각 state를 Hamiltonian의 eigenstate $\phi_n$ 으로 잡는다. 
